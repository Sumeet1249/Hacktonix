        ...
        <div className="w-full max-w-[440px]">
          <div className="bg-white/70 backdrop-blur-2xl border border-white rounded-[40px] p-12 shadow-[0_32px_80px_rgba(31,38,135,0.07)]">
            ...
            <div className="mb-10 text-center">
              <div className="w-20 h-20 bg-indigo-600 rounded-3xl mx-auto flex items-center justify-center shadow-[0_20px_40px_rgba(79,70,229,0.3)] mb-6 ring-8 ring-indigo-50 transition-transform hover:rotate-6">
                <Shield size={36} className="text-white" />
              </div>
              <h1 className="text-3xl font-display text-slate-900 mb-2">Welcome Back</h1>
              <p className="text-slate-500 text-sm font-body">Access the Obsidian Sentinel engine</p>
            </div>
            ...
            <div className="space-y-6">
              <div className="relative">
                ...
                <div className="relative flex justify-center text-xs uppercase"><span className="bg-white px-4 text-slate-400 font-technical tracking-widest">Identify via Global Auth</span></div>
              </div>

              <button 
                onClick={handleGoogleLogin}
                className="w-full flex items-center justify-center gap-4 py-4 bg-white rounded-2xl border border-slate-100 shadow-sm hover:shadow-md hover:bg-slate-50 transition-all font-body font-bold text-slate-700"
              >
              ...
              <p className="text-[10px] text-center text-slate-400 font-body px-8 leading-relaxed">
                By continuing, you authorize BlindSpot AI to verify your credentials via Supabase Secure Gateway.
              </p>
            </div>
            ...
            <div className="mt-12 pt-8 border-t border-slate-50 grid grid-cols-2 gap-4">
              <div className="flex items-center gap-2 opacity-50 grayscale hover:grayscale-0 hover:opacity-100 transition-all cursor-default">
                ...
                <span className="text-[9px] font-technical font-bold uppercase tracking-wider text-slate-600">Encrypted</span>
              </div>
              <div className="flex items-center gap-2 opacity-50 grayscale hover:grayscale-0 hover:opacity-100 transition-all cursor-default">
                <Eye size={12} className="text-emerald-500" />
                <span className="text-[9px] font-technical font-bold uppercase tracking-wider text-slate-600">Monitored</span>
              </div>
            </div>
          </div>
        </div>
